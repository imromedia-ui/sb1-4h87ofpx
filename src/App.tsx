  ...
  return (
    <div className="min-h-screen bg-warm-white flex">
      ...
      <div className="min-h-screen bg-white">
            ...
            <div className="max-w-6xl mx-auto px-8">
              ...
              <div className="mb-16">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
                  ...
                  <div className="bg-gray-50 border border-gray-200 p-8 rounded-lg text-center">
                    <div className="flex justify-between items-center mb-4">
                      <h3 className="text-2xl font-serif font-medium text-black">MIC Injections</h3>
        ...
        {!['home', 'services', 'contact', 'reviews', 'shop', 'team', 'policies', 'womens-health', 'mens-health', 'iv-treatments'].includes(currentPage) && (
          <div className="py-24 bg-white">
            <div className="max-w-6xl mx-auto px-8">
              <h1 className="text-5xl font-serif font-light text-center mb-16" style={{ color: '#D4AF37' }}>
